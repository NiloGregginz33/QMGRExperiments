...
def interpret_results(counts):
    ...
    print("\nImplications:")
    print("- A near-uniform distribution across multiple states may suggest a higher degree of randomness in radiation emission.")
    print("- Shifting balances between states could indicate that the system's quantum state evolves dynamically, with external factors (like time gaps) introducing complexity.")
    print("- If one state becomes significantly dominant, it may hint at stable charge patterns driving the emissions.")

    print("- The interesting thing here is that the entropy is NOT PERFECTLY at 2.0, it sits slightly lower")
