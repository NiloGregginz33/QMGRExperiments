...
def explain_experiment():
    """
    Outputs the context and purpose of the experiment.
    """
    print("\nExperiment Context:")
    print("This experiment simulates the Many-Worlds interpretation of quantum mechanics.")
    print("- The black hole qubit is prepared in a superposition, representing multiple quantum states simultaneously.")
    print("- Hawking radiation qubits are entangled with the black hole qubit to simulate information transfer.")
    print("- Decoherence is added to mimic the branching of wavefunctions in the Many-Worlds framework.")
    print("- Measurements represent the observed states across different branches of the multiverse.")
    print("\nGoals:")
    print("- Explore how decoherence impacts the distribution of measurement outcomes.")
    print("- Analyze entropy as a measure of randomness or coherence in the system.")
    print("- Investigate the role of entanglement in preserving or transferring information.")


# Function to run and display results
def run_and_display_results(qc, backend, shots=1024):
    """
    Executes the quantum circuit and displays the measurement results alongside the circuit.

    Parameters:
        qc (QuantumCircuit): The quantum circuit to execute.
        backend (Backend): The IBM backend or simulator to use.
        shots (int): Number of shots for the experiment.

    Returns:
        None: Displays the circuit, measurement histogram, and entropy analysis.
    """
    try:
        ...
        entropy_value = calculate_shannon_entropy(counts, shots)
        print(f"\nEntropy of Measurement Results: {entropy_value:.4f} bits")

    except Exception as e:
        print(f"Error in running and displaying results: {e}")
...
# Parameters for the circuit
    ...
    run_and_display_results(transpiled_qc, backend=best_backend)
