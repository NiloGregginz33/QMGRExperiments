...
**All work in later internal/3rd party experimental files (eg. wedge comparison) post date the first public disclosure and are considered non enabling beyond demonstration. Matrix Solutions LLC is aware of the pre existing prior art on static wedge reconstruction.
