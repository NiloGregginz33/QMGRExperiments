#!/usr/bin/env python3
"""
Enhance All Instance Directory Graphs with Error Bars
===================================================

This script enhances all graphs in an instance directory with error bars, 
...
def enhance_correlation_plot(instance_dir: str, error_data: Dict):
    """Enhance correlation plot with error bars."""
...
def enhance_ricci_scalar_plot(instance_dir: str, error_data: Dict):
    ...
    # Calculate simple error estimate (standard deviation if multiple values)
...
def main():
    """Main function to enhance all graphs in instance directory."""
    if len(sys.argv) != 2:
        print("Usage: python enhance_all_instance_graphs.py <instance_directory>")
        print("Example: python enhance_all_instance_graphs.py experiment_logs/custom_curvature_experiment/instance_20250726_153536")
        return
    ...
    print(f"Enhancing all graphs in: {instance_dir}")
